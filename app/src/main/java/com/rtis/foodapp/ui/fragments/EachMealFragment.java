...
public class EachMealFragment extends Fragment {
    ...
    public static EachMealFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View customView=inflater.inflate(R.layout.demo, container, false);
        LinearLayout timeView=(LinearLayout)customView.findViewById(R.id.timeView);
